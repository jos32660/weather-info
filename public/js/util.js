...
function dspDate(d, type){
	...
	var monthArr2 = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"];
	var weekArr = ["SUNDAY", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY, FRIDAY, SATURDAY"];
	var year = d.getFullYear() + "년"; //2019
	var month = monthArr[d.getMonth()]+" "; // 7 (0~11)
	var month2 = "&nbsp;&nbsp;"+ monthArr2[d.getMonth()]; // 7 (0~11)
	...
	*/
	...
	switch(type){
		...
		case 5:
			...
			break;
		case 6:
				returnStr = day2 + month2;
			break;
		default:
				returnStr = year + month + day + week + hour + min + sec;
			break;
	}
	return returnStr;
}